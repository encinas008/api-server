 ...
 * @license         MIT
 */
class Solicitante extends MY_Controller {
    ...
    /**
    * get Solicitante by token declaracion jurada
    * --------------------------
    * @param: array persona
    ...
    * @method: POST
    * @author: RAR
    * @link: api/solicitante/token-licencia-by-lic/(:token)
    */
    public function getSolicitanteByTokenDJ_get($token_dj){
